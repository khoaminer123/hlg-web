...
const ModelHLG: React.FC = () => {
  ...
  const serviceCards = [
    {
      title: "Đời sống HLG",
      sub: "Hơn 30 triệu người dùng đang sử dụng",
      bgColor: "bg-white",
    ...
    {
      title: "Siêu thị HLG",
      sub: "1.818 siêu thị hợp tác đã ra mắt",
      bgColor: "bg-white",
      textColor: "text-[#142077]",
    ...
    },
    {
      ...
      sub: "490.000+ đối tác đã gia nhập",
      bgColor: "bg-white",
      textColor: "text-[#142077]",
    ...
    },
    {
      ...
      sub: "1.028 trung tâm dịch vụ đã đi vào hoạt động",
      bgColor: "bg-white",
      textColor: "text-[#142077]",
    ...
    {
      title: "HLG Coffee",
      sub: "Dự kiến mở 500 cửa hàng vào năm 2025",
      bgColor: "bg-white",
      textColor: "text-[#142077]",
  ...
  const honorCards = [
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1491336477066-31156b5e4f35?q=80&w=600&auto=format&fit=crop",
    },
    {
    ...
    },
    {
      ...
      desc: "Tháng 10 năm 2024, được trao tặng bằng khen 'Doanh nghiệp thí điểm kinh doanh phân tách tín dụng tiêu dùng xanh'.",
  ...
  return (
    <div className="pt-[88px] bg-[#fbfbfb] pb-32">
            ...
            {serviceCards.map((card, idx) => (
              ...
              >
                ...
                <div className="relative z-10 mr-2">
                  <div className="w-10 h-10 rounded-full bg-white/60 backdrop-blur-sm border border-white flex items-center justify-center text-gray-400 group-hover:bg-pink-primary group-hover:text-white transition-all shadow-sm">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            {honorCards.map((card, idx) => (
              ...
              >
                ...
                <div className="space-y-3">
                  <h4 className="text-lg font-black text-gray-800 leading-tight group-hover:text-pink-primary transition-colors">
                    {card.title}
                  </h4>
          ...
          {/* <div className="mt-12 flex justify-end items-center space-x-4 text-sm font-bold text-gray-400">
            ...
            <div className="flex items-center space-x-2">
              <button className="w-8 h-8 flex items-center justify-center rounded-lg hover:text-pink-primary transition-colors">
      ...
      {/* FIXED PARTNER BAR */}
      <div
        className={`fixed bottom-8 left-1/2 -translate-x-1/2 w-[90%] max-w-2xl bg-white/90 backdrop-blur-md rounded-full px-8 py-3 shadow-2xl border border-gray-100 z-[110] flex items-center justify-between transition-all duration-500 ${
          showPartnerBar
