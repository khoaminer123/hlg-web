      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative w-full max-w-3xl">
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-12 pr-32 py-4 bg-white border border-gray-200 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-hlg-blue/20 focus:border-hlg-blue transition-all text-sm"
                value={searchTerm}
        ...
        <div className="flex flex-col items-center justify-center space-y-8 animate-fadeIn">
          <div className="relative w-64 h-64 md:w-80 md:h-80 flex items-center justify-center">
            ...
            <div className="absolute top-0 right-0 w-20 h-10 bg-indigo-50 rounded-full blur-xl opacity-60"></div>
            <div className="absolute bottom-10 left-0 w-16 h-8 bg-indigo-50 rounded-full blur-xl opacity-60"></div>
            ...
            <div className="relative z-10 w-32 md:w-40 aspect-[4/5] bg-white rounded-xl shadow-2xl border-[6px] border-[#117BF4] flex flex-col items-center p-4">
              ...
              <div className="w-full space-y-3 mt-4">
                <div className="h-2 w-3/4 bg-indigo-50 rounded-full"></div>
                <div className="h-2 w-full bg-indigo-50 rounded-full"></div>
                <div className="h-2 w-1/2 bg-indigo-50 rounded-full"></div>
                <div className="h-2 w-2/3 bg-indigo-50 rounded-full"></div>
              </div>
              {/* Pink Pencil */}
            ...
            {/* Base platform */}
            <div className="absolute bottom-0 w-64 h-32 bg-gradient-to-t from-indigo-50 to-transparent rounded-[100%] -z-10 opacity-30"></div>
          </div>
